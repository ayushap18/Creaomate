            ...
            <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl rounded-2xl shadow-2xl shadow-slate-300/20 dark:shadow-black/20">
                <div className="p-8">
                    <div className="text-center">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 mt-1">Join a community of creators and supporters.</p>
                    </div>
                    ...
                    <div>
                        <Button variant="social" type="button" onClick={handleGoogleSignUp} className="w-full" isLoading={isGoogleLoading}>
                    ...
                    <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-6">
                        ...
                        <button onClick={() => setAuthPage('login')} className="font-semibold text-teal-600 dark:text-teal-400 hover:underline">
                            Log In
                        </button>
                    </p>
                </div>
